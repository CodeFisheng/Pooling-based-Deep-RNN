...
num_epoches = 2000 # training epoches for each customer samples
n_steps = 48 # input size
test_batch_size = 70*48 # days of a batch
train_batch_size = 30*48
...
result_final = []
simcuslist = [0,266,295,431,465,597,615,627,736,798]
discuslist = [0,230,460,487,520,655,754,767,818,907]
for i in range(0,1):
    ii = i#discuslist[i]
    print ii
